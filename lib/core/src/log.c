...
{
    switch (level) {
    case CLAWD_LOG_TRACE: return "TRACE";
    case CLAWD_LOG_DEBUG: return "DEBUG";
    case CLAWD_LOG_INFO:  return "INFO ";
    case CLAWD_LOG_WARN:  return "WARN ";
    case CLAWD_LOG_ERROR: return "ERROR";
    case CLAWD_LOG_FATAL: return "FATAL";
    default:              return "?????";
    }
}
