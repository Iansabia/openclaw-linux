 ...
 * is reported as unavailable via clawd_sandbox_available().
 *
 * SPDX-License-Identifier: MIT
 */

#ifndef CLAWD_SANDBOX_H
#define CLAWD_SANDBOX_H
...
typedef struct clawd_sandbox_opts {
...
} clawd_sandbox_opts_t;

/* ---- Opaque handle ------------------------------------------------------ */

typedef struct clawd_sandbox clawd_sandbox_t;
